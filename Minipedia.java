...
public class Minipedia extends MiniGoogle{
  ...
  /*calls method from google*/
  public static  void PhraseSearch(Scanner s, ArticleTable D){
      System.out.println();
    ...
    String title = s.nextLine();
    String ans = phraseSearch(title, D);
  ...
  public static void main(String[] args) {
    ...
    L.initialize(A);  //changed this 
   L.reset();
 //  System.out.println(L.badBucket()); //prunts out buckets per table entry
    
  //  System.out.println(L.MasterList());
